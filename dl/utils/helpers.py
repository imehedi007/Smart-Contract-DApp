...
def draw_bbox_info(frame, bbox, similarity, name, color, nid=None):
    """
    Draw bounding box with name and similarity score on frame.
    ...
    Args:
        ...
        nid: NID number (optional, not displayed)
    """
    x1, y1, x2, y2 = map(int, bbox)

    # Display text with person's name and confidence
